...
SanctusTenoreNotes = {
	\relative c' {
		...
		r2 \mvTr h4\fE^\tuttiE cis
		e2 e4 a,~
		a4. h8 cis4 d(
		cis2) h4 r
		r2 d4 d8 d %5
		d4 cis8([ h)] a4( fis'
		e4.) e8 \tempoPleni e e e e
		d4 d8 d a a r4
		R1
		r2 d8. d16 d4 %10
		r2 e8. e16 e4
		r2 d8. d16 d4
		d8 d16 d e8 e16 e e8 e r cis
		fis8. fis16 e8 dis e e r e
		e8. e16 e8 d a2 %15
...
AgnusDeiTenoreNotes = {
	\relative c' {
		...
		r cis dis h %15
		r h cis a \noBreak
		\tempoAgnusDeiFinis a2 a\fermata \bar "||"
		\time 4/4 \tempoDona R1*5 %22
		r2 r8 e'4 e8
		cis a r e'( cis) a r h
		cis[ a16 h] cis[ d] e4 d cis8 %25
		r h([ cis)] ais r h([ cis)] ais
		r h4( cis16[ d)] e8 h4 h8
		r cis([ h)] gis r cis([ h)] gis
		r \once \tieDashed cis4~ cis8 h8 d([ cis)] ais
		r d([ cis)] ais r d[( e cis] %30
		d[ h] a4) a a16([ h cis8)]
		a8 a4 a8 r a4 a8
		d([ h)] cis([ a)] g a4 a8
		a4 a a a
		a a a r\fermata \bar "|." %35 FINIS
	}
}
